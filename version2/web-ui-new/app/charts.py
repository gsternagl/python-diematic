    ...
    def get_data(self, time_span, show_gaps):
        ...
        if not self.INFLUX_EMULATION:
            ...
            if client is not None:
                ...
                query = 'SELECT mean(temp_ext), mean(temp_ecs), mean(temp_boiler) ' + \
                ...
                if result is not None:
                    ...
                    for point in points:
                        ...
                        if not has_gap:
                            ...
                            data_values1.append(v1)
                            data_values2.append(v2)
                            data_values3.append(v3)
        ...
        # fill list with some predefined values
            ...
            v1 = [10,11,13,14,13,12,10]    
            v2 = [40,41,43,45,43,42,40]
            v3 = [60,62,70,75,70,65,60]
            ...
            while curr_time < end_time:
                ...
                data_values1.extend(v1)
                data_values2.extend(v2)
                data_values3.extend(v3)
                curr_time += interval
